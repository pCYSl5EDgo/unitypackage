...
export module UnityPackageCreator {
    ...
    export const createMetaFolderUnderFolder = (folderContainsMetaFolders: string, metaFileRelativePathWithExtension: string, projectRoot: string, callback?: NoParamCallback, logger?: (logText: string) => void) => {
    ...
    export const createUnityPackageFromMetaFilePathsWithTempFolder = (metaFiles: string[], projectRoot: string, output: string, folderContainsMetaFolders: string, logger?: (logText: string) => void) => {
